package com.avichal.spark.jobs.RealTimeFraudDetection

import com.avichal.cassandra.dao.{KafkaOffsetRepository, CreditcardTransactionRepository}
import com.avichal.cassandra.{CassandraDriver, CassandraConfig}
import com.avichal.config.Config
import com.avichal.creditcard.Schema
import com.avichal.kafka.KafkaConfig
import com.avichal.spark.{DataReader, GracefulShutdown, SparkConfig}
import com.avichal.spark.jobs.SparkJob
import com.avichal.utils.Utils
